 ...
 * @author bagon
 */
public class InsertIntoProduct extends Migrations {
    public InsertIntoProduct() {
    ...
    public void doMigrate() {
        this.query = "INSERT INTO " + this.tableName
                ...
                + "('Pepsodent variant Green Tea', '250#353#Gang 1 Lorong 1', 15000, 70),"
                + "('Pepsodent variant Herbal', '250#353#Gang 1 Lorong 1', 15000, 70)";
